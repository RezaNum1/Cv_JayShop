           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>  <a href="index.php?halaman=produk"><i class="fa fa-dashboard fa-3x"></i> Produk</a></li><!--dikasih parameter halaman = halaman(halaman = produk produk harus huruf kecil semua)-->
